...
class ObjectDetectionNode:
    def __init__(self):
        ...
        self.point_pub = rospy.Publisher('/transformed_point', PointStamped, queue_size=10)  # Publisher for visualizing points in rviz
    ...
    def publish_transformed_point(self, point, frame_id):
            ...
            for obj in self.detected_objects:
                ...
                if Z > 0:  # Ensure depth is valid
                    ...
                    if robot_base_coords is not None:
                        ...
                        # Publish transformed point for visualization
                        self.publish_transformed_point(robot_base_coords, self.target_frame)
