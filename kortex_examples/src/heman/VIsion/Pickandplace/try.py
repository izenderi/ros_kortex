...
class ObjectDetectionNode:
    ...
    def detect_green_rectangle(self, image, obj):
        ...
        for contour in contours:
            ...
            if len(approx) == 4:
                ...
                if obj.xmin <= x and obj.xmax >= x + w and obj.ymin <= y and obj.ymax >= y + h:
    ...
    def draw_detected_objects(self):
        if self.latest_image is not None and self.latest_point_cloud is not None:
            ...
            for obj in self.detected_objects:
                ...
                # Detect and draw green rectangle
                green_rect_coords = self.detect_green_rectangle(self.latest_image, obj)
                if green_rect_coords:
                    rospy.loginfo(f"Detected green rectangle at coordinates: {green_rect_coords}")
